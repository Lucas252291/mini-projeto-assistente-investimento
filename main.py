...
time.sleep(1.5)
taxa_rendimento_110_porcento = taxa_final_investimento_renda_fixa(1.10)
taxa_rendimento_120_porcento = taxa_final_investimento_renda_fixa(1.20)
taxa_rendimento_95_porcento = taxa_final_investimento_renda_fixa(0.95)
...
time.sleep(1.0)
print(f"[B]{cor_azul}CDB{reset} valendo 110% do CDI, taxa final de {cor_roxo}{taxa_rendimento_110_porcento:.2f}%{reset}")
time.sleep(1.0)
print(f"[C]{cor_azul}CDB{reset} valendo 120% do CDI, taxa final de {cor_roxo}{taxa_rendimento_120_porcento:.2f}%{reset}")
time.sleep(1.0)
print(f"[D]{cor_azul}LCA{reset} valendo 95% do CDI, taxa final de  {cor_roxo}{taxa_rendimento_95_porcento:.2f}%{reset}")
time.sleep(1.0)
